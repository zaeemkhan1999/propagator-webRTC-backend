...
public class FollowRequestEventHandler : INotificationHandler<FollowRequestEvent>
{
    private readonly IArticleRepository _repository;
    private readonly INotificationService _notificationService;
    private readonly ITopicEventSender _sender;

    public FollowRequestEventHandler(
    ...
    public async Task Handle(FollowRequestEvent notification, CancellationToken cancellationToken)
    {
        ...
        var notif = new Notification()
        {
            ...
            IsReaded = false,
            Text = $"{senderIdentifier} followed you:",

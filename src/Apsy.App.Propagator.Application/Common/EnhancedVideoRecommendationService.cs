...
public class EnhancedVideoRecommendationService
{
    ...
    public async Task<List<PostDto>> RecommendPostsForUser(IPostRepository repository, User currentUser)
    {
    ...
    public List<PostDto> RecommendPostsForUserForHanlder(IPostRepository repository, User currentUser)
    {
        _currentUser = currentUser;
        _repository = repository;

...
public class StrikeRepository : Repository<Strike, DataReadContext>, IStrikeRepository
{
    public StrikeRepository(IDbContextFactory<DataReadContext> dbContextFactory) : base(dbContextFactory)
    {

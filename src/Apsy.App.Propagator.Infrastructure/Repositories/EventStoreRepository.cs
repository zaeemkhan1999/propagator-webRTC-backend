...
{
    public class EventStoreRepository : Repository<EventModel, DataReadContext>, IEventStoreRepository
    {
        public EventStoreRepository(IDbContextFactory<DataReadContext> dbContextFactory) : base(dbContextFactory)
        {

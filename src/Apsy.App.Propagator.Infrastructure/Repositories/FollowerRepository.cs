...
public class FollowerRepository : Repository<UserFollower, DataReadContext>, IFollowerRepository
{
    public FollowerRepository(IDbContextFactory<DataReadContext> dbContextFactory) : base(dbContextFactory)
    {

...
public class ArticleRepository : Repository<Article, DataReadContext>, IArticleRepository
{
    public ArticleRepository(IDbContextFactory<DataReadContext> dbContextFactory) : base(dbContextFactory)
    {

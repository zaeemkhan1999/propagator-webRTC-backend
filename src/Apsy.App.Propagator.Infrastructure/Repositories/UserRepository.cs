...
public class UserRepository : UserRepositoryBase<DataReadContext, User>, IUserRepository
{
    public UserRepository(
        UserManager<AppUser> userManager,
        IDbContextFactory<DataReadContext> dbContextFactory) : base(dbContextFactory)
    {

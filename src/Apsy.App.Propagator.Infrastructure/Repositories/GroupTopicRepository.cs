...
public class GroupTopicRepository : Repository<GroupTopic, DataReadContext>, IGroupTopicRepository
{
    public GroupTopicRepository(IDbContextFactory<DataReadContext> dbContextFactory) 

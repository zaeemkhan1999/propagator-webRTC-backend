...
public class PostRepository : Repository<Post, DataReadContext>, IPostRepository
//: PostRepositoryBase<User, Post, PostLikes, Comment, DataReadContext>, IPostRepository
{
    public PostRepository(IDbContextFactory<DataReadContext> dbContextFactory) : base(dbContextFactory)
    {

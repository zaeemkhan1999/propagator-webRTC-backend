...
public class SaveArticleReadRepository
 : Repository<SaveArticle, DataWriteContext>, ISaveArticleReadRepository
{
public SaveArticleReadRepository(IDbContextFactory<DataWriteContext> dbContextFactory )

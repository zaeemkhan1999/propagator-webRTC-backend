...
public class ArticleLikeReadRepository
 : Repository<ArticleLike, DataWriteContext>, IArticleLikeReadRepository
{
public ArticleLikeReadRepository(IDbContextFactory<DataWriteContext> dbContextFactory )

...
public class StorySeenReadRepository
            
 : Repository<StorySeen, DataWriteContext>, IStorySeenReadRepository
{
	public StorySeenReadRepository(IDbContextFactory<DataWriteContext> dbContextFactory)

...
public class PostLikeReadRepository : Repository<PostLikes, DataWriteContext>, IPostLikeReadRepository
{

    public PostLikeReadRepository(IDbContextFactory<DataWriteContext> dbContextFactory) : base(dbContextFactory)
    {

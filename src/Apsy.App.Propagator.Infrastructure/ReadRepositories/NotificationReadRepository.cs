...
public class NotificationReadRepository : Repository<Notification, DataWriteContext>, INotificationReadRepository
{
    public NotificationReadRepository(IDbContextFactory<DataWriteContext> dbContextFactory) : base(dbContextFactory)
    {

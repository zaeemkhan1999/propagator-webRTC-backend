...
public class ArticleCommentReadRepository
 : Repository<ArticleComment, DataWriteContext>, IArticleCommentReadRepository
{
public ArticleCommentReadRepository(IDbContextFactory<DataWriteContext> dbContextFactory )

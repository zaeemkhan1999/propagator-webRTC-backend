...
public class GroupRequestReadRepository : Repository<GroupRequest, DataWriteContext>, IGroupRequestReadRepository
{
    public GroupRequestReadRepository(IDbContextFactory<DataWriteContext> dbContextFactory) : base(dbContextFactory)
    {

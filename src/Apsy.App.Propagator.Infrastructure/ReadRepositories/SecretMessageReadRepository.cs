...
public class SecretMessageReadRepository : Repository<SecretMessage, DataWriteContext>, ISecretMessageReadRepository
{
    public SecretMessageReadRepository(IDbContextFactory<DataWriteContext> dbContextFactory) : base(dbContextFactory)
    {

...
public class CommentReadRepository : Repository<Comment, DataWriteContext>, ICommentReadRepository
{
    public CommentReadRepository(IDbContextFactory<DataWriteContext> dbContextFactory) : base(dbContextFactory)
    {

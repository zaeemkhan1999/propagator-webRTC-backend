        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSendAll = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicNotification", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    TotalPostsCount = table.Column<int>(type: "int", nullable: false),
                    TotalArticlesCount = table.Column<int>(type: "int", nullable: false),
                    TotalPostCommentsCount = table.Column<int>(type: "int", nullable: false),
                    TotalArticleCommentsCount = table.Column<int>(type: "int", nullable: false),
                    TotalTagsCount = table.Column<int>(type: "int", nullable: false),
                    TotalTagsViews = table.Column<int>(type: "int", nullable: false),
                    TotalPostLikesCount = table.Column<int>(type: "int", nullable: false),
                    TotalArticleLikesCount = table.Column<int>(type: "int", nullable: false),
                    TotalPromotedPostsCount = table.Column<int>(type: "int", nullable: false),
                    TotalPromotedArticlesCount = table.Column<int>(type: "int", nullable: false),
                    TotalAdsesCount = table.Column<int>(type: "int", nullable: false),
                    TotalStoriesCount = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                name: "AdminTodayLimitation",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    SuspendedCount = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminTodayLimitation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdminTodayLimitation_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LatestMessageUserId = table.Column<int>(type: "int", nullable: false),
                    LatestMessageDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    IsBothUserJoinedToChat = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    FirstUserId = table.Column<int>(type: "int", nullable: false),
                    FirstUserPublicKey = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SecondUnreadCount = table.Column<int>(type: "int", nullable: false),
                    SecondUserId = table.Column<int>(type: "int", nullable: false),
                    SecondUserPublicKey = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FirstUnreadCount = table.Column<int>(type: "int", nullable: false),
                    IsSelfDestruct = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    SelfDestructTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecretConversation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SecretConversation_User_FirstUserId",
                        column: x => x.FirstUserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SecretConversation_User_SecondUserId",
                        column: x => x.SecondUserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SecurityAnswer_SecurityQuestion_SecurityQuestionId",
                        column: x => x.SecurityQuestionId,
                        principalTable: "SecurityQuestion",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SecurityAnswer_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    SecretConversationId = table.Column<int>(type: "int", nullable: false),
                    SenderId = table.Column<int>(type: "int", nullable: false),
                    AesEncryptedText = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AesKeyEncryptedByRsaUsingSenderPublicKey = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AesIvEncryptedByRsaUsingSenderPublicKey = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AesKeyEncryptedByRsaUsingReceiverPublicKey = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AesIvEncryptedByRsaUsingReceiverPublicKey = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsSenderDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsReceiverDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AesEncryptedMessageType = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AesEncryptedContentAddress = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    AesEncryptedProfile = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AesEncryptedPost = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AesEncryptedArticle = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AesEncryptedStory = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ParentSecretMessageId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecretMessage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SecretMessage_SecretConversation_SecretConversationId",
                        column: x => x.SecretConversationId,
                        principalTable: "SecretConversation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SecretMessage_SecretMessage_ParentSecretMessageId",
                        column: x => x.ParentSecretMessageId,
                        principalTable: "SecretMessage",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SecretMessage_User_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SecretMessage_User_SenderId",
                        column: x => x.SenderId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminTodayLimitation_UserId",
                table: "AdminTodayLimitation",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecretConversation_FirstUserId",
                table: "SecretConversation",
                column: "FirstUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SecretConversation_SecondUserId",
                table: "SecretConversation",
                column: "SecondUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SecretMessage_ParentSecretMessageId",
                table: "SecretMessage",
                column: "ParentSecretMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_SecretMessage_ReceiverId",
                table: "SecretMessage",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_SecretMessage_SecretConversationId",
                table: "SecretMessage",
                column: "SecretConversationId");

            migrationBuilder.CreateIndex(
                name: "IX_SecretMessage_SenderId",
                table: "SecretMessage",
                column: "SenderId");

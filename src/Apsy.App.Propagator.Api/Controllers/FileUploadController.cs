...
namespace Propagator.Api.Controllers
{
    ...
    public class FileUploadController : Controller
    {
        ...
        private const int MaxFileSize = 1073741224; // 1GB


        public FileUploadController(IConfiguration configuration, IAuthService authService, IPostService postService)
        {
